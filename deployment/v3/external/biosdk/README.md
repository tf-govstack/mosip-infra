...
* For development and testing, MOSIP provides biosdk service. See [Biosdk](../../tf-govstack/biosdk/README.md).

## Introduction
* [Overview](https://github.com/tf-govstack/mosip-ref-impl/tree/develop/biosdk-services).
...
## Install
The same will be installed as part of MOSIP services as [biosdk service](../../tf-govstack/biosdk).
